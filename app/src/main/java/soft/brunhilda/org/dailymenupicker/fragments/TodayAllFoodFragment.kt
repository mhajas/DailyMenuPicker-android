...
import kotlinx.android.synthetic.main.content_restaurant_menu.*
...
class TodayAllFoodFragment : Fragment(), PlacesListener{
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        adapterItemsPreparer = AdapterItemsResolver(activity, main_list_view, mutableMapOf())
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater?.inflate(R.layout.content_restaurant_menu, container, false)
    }
